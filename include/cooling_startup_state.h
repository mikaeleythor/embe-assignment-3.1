#ifndef COOLING_STARTUP_STATE_H

#include <state.h>

#define COOLING_STARTUP_STATE_H

class Cooling_startup_state : public State {
  void on_do() override;
  ...
  String name = "Cooling startup";
};

#endif // !COOLING_STARTUP_STATE_H
